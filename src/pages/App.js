...
import SimpleInventory from './pages/SimpleInventory';   // ✅ 앱용 재고관리
import SimplePurchase from './pages/SimplePurchase';     // ✅ 앱용 검수매입
    ...
    return (
      <>
        ...
        {page === 'adminPC_coupons' && (
          <div style={{ display: 'flex', height: '100vh', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
            {(() => { const Sidebar = require('./components/layout/Sidebar').default; return <Sidebar currentPage="adminPC_coupons" setPage={goToPage} dark={adminDark} />; })()}
            <div style={{ flex: 1, overflowY: 'auto', background: adminDark ? '#111' : '#f5f5f3' }}>
