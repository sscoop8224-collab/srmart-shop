...
function Login({ onLogin, onGuest }) {
  ...
  //   · 지점 통합 회원·포인트·구매 내역 제3자 제공 [선택] — 5개 지점이 **서로 다른
  //     사업자**라, 한 곳에서 가입한 회원 정보를 다른 지점이 쓰려면 제3자 제공 동의가
  //     필요하다. 동의하지 않아도 가입·주문은 그대로 되고, 매장 포인트 통합과 **매장
  //     구매 내역 표시(전자영수증)** 만 빠진다.
  //
            ...
            <>
              ...
              <div style={{ marginTop: 18, padding: 14, borderRadius: 12, background: COLORS.greenTint, border: `1px solid ${COLORS.greenBorder}` }}>
                ...
                <ConsentRow
                  ...
                  label="지점 통합 회원·포인트·구매 내역 이용 동의"
                  detail="에스알마트 각 지점(승학·검암·왕길·신흥·고촌)은 서로 다른 사업자입니다. 동의하시면 모든 지점에서 포인트를 함께 쌓고 쓰시고, 매장 구매 영수증도 앱에서 보실 수 있어요. 제공 항목은 이름·연락처·회원번호·포인트 내역·매장 구매 내역입니다. 동의하지 않으셔도 가입과 온라인 주문은 그대로 가능하며, 이 경우 매장 포인트 적립·사용과 매장 구매 내역 표시만 제한됩니다."
                />
